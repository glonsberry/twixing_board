...
- Create sounds based on the mood and occurrence frequency of tweets.  User can adjust the volume of twixnotes (sounds).  The app acts as a musical instrument that generates sound by the mass expression of thought.
