...
- Create sounds based on the mood and occurance of tweets.  It simulates a mixboarding in the fact you can adjust the volume of twixnotes (sounds).  The fun behind the app is to find tweets according to your liking as different searchs yield different results.
...
This application is meant to be run in a browser.
